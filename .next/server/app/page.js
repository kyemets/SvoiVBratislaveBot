(() => {
  ...
  ((e.id = 931),
    ...
    (e.modules = {
        ...
        let d = [
            "",
            {
              children: [
                ...
                {
                  page: [
                    () => Promise.resolve().then(t.bind(t, 5480)),
            ...
            {
              layout: [
                () => Promise.resolve().then(t.bind(t, 9176)),
          ...
          c = ["/Users/kostiantyn/Downloads/bratislava-app/src/app/page.tsx"],
          p = "/page",
      ...
      8792: (e, a, t) => {
        Promise.resolve().then(t.bind(t, 4497));
      },
      4497: (e, a, t) => {
        "use strict";
...
`,
        ...
        function x({ count: e, label: a, delay: t, duration: n = 1100 }) {
          let r = (function (e, a = 1100, t = 200) {
            return (0, s.useRef)(null);
          })(0, n, t);
          return (0, i.jsxs)("div", {
            ...
            children: [
              i.jsx("div", {
                ...
                children: i.jsx("span", { ref: r, children: "0" }),
              }),
              i.jsx("div", {
                style: {
        ...
        function m() {
          var e;
          let a = r.jt[r.jt.length - 1],
            t = r.RH[r.RH.length - 1],
            m = r.FP[r.FP.length - 1],
            h = r.jt[((e = r.jt.length), Math.floor(Date.now() / 864e5) % e)],
            f = {
              specialists: r.jt.length,
              listings: r.RH.length,
              events: r.FP.length,
              jobs: r.WN.length,
              housing: r.H.length,
            },
            ...
            y = g ? 0 : 1100;
          return (0, i.jsxs)("div", {
            className: g ? "animations-done" : "",
            children: [
              i.jsx("style", { dangerouslySetInnerHTML: { __html: d } }),
              (0, i.jsxs)("div", {
                style: {
                  background: "var(--blue)",
                ...
                children: [
                  ...
                  (0, i.jsxs)("h1", {
                    ...
                    children: ["Свои", i.jsx("br", {}), "в Братиславе"],
                  }),
                  i.jsx("p", {
              ...
              (0, i.jsxs)("div", {
                ...
                children: [
                  ...
                  i.jsx("div", {
                    ...
                    children: i.jsx(n.default, {
                      href: `/catalog/${h.category}/${h.id}`,
                  ...
                  (0, i.jsxs)("div", {
                    ...
                    children: [
                      i.jsx("div", {
                        ...
                        children: i.jsx(n.default, {
                          href: `/catalog/${a.category}/${a.id}`,
                          style: { textDecoration: "none" },
                          children: i.jsx("div", {
                            className: "pressable",
                            children: i.jsx(o.Card, {
                              children: (0, i.jsxs)("div", {
                                style: {
                                  padding: "14px 16px",
                                  display: "flex",
      ...
      5480: (e, a, t) => {
        "use strict";
        (t.r(a),
          t.d(a, { $$typeof: () => r, __esModule: () => s, default: () => l }));
        var i = t(8570);
        let n = (0, i.createProxy)(
            String.raw`/Users/kostiantyn/Downloads/bratislava-app/src/app/page.tsx`,
          ),
          { __esModule: s, $$typeof: r } = n;
        n.default;
        let l = (0, i.createProxy)(
          String.raw`/Users/kostiantyn/Downloads/bratislava-app/src/app/page.tsx#default`,
        );
      },
    }));
