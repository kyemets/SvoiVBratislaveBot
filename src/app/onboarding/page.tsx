    ...
    <div style={{
      ...
      {!isLast && (
        <button onClick={handleSkip} style={{
          ...
          color: 'rgba(255,255,255,0.5)', fontSize: '14px', cursor: 'pointer', padding: '4px',
        }}>
          Пропустить
        </button>
      )}
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
        ...
        <h1 style={{ margin: '0 0 16px', color: '#fff', fontSize: '26px', fontFamily: 'Unbounded, sans-serif', lineHeight: 1.2 }}>
          {slide.title}
        </h1>
        <p style={{ margin: 0, color: 'rgba(255,255,255,0.7)', fontSize: '16px', lineHeight: 1.6, maxWidth: '280px' }}>
          {slide.desc}
        </p>
      </div>
